...
constexpr char kDatabaseSchema[] = "BEGIN;"
                                   ...
                                   "CREATE TABLE switch (endpoint_id INTEGER PRIMARY KEY, mobilus_device_id INTEGER UNIQUE NOT NULL, unique_id TEXT UNIQUE NOT NULL, state INTEGER NOT NULL, name TEXT NOT NULL);"
