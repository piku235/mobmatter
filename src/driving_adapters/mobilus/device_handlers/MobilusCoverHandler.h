...
public:
    ...
    HandlerResult handle(const proto::Device& deviceInfo, const proto::Event& currentState) override;
...
private:
    ...
    HandlerResult init(model::window_covering::CoverSpecification coverSpec, const proto::Device& device, const proto::Event& currentState);
